...
class PlaybackCoordinatorTest {
    ...
    @Test
    fun autoAdvanceUsesCycleWhenBookEnds() {
        val result = coordinator.resolveAutoAdvance(
            book1,
            t2,
            cycle,
            mapOf("book-one" to book1, "book-two" to book2),
            mapOf("b1" to listOf(t1, t2), "b2" to listOf(t3)),
        )
