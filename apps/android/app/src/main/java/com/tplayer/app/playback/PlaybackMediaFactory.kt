        ...
        val metadataBuilder = MediaMetadata.Builder()
            ...
            .setMediaType(
                when (meta.contentType) {
                    com.tplayer.app.domain.model.ContentType.AUDIOBOOK -> MediaMetadata.MEDIA_TYPE_AUDIO_BOOK
                    com.tplayer.app.domain.model.ContentType.MUSIC -> MediaMetadata.MEDIA_TYPE_MUSIC
                },
            )
